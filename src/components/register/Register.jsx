...
<<<<<<< HEAD
      const response = await axios.get(
        "http://143.244.142.0/api/v1/organizations/fetch/org/"
      );
=======
...
<<<<<<< HEAD
      const response = await axios.get(
        "http://143.244.142.0/api/v1/parts/get/marketplace/"
      );
=======
...
<<<<<<< HEAD
      const response = await axios.post(
        "http://143.244.142.0/api/v1/users/new/create/user/",
        userData
      );
      if (response.data) {
        setUserData({
      ...
      const orgError = error.response.data.org
        ...
        : "";
      setError(
        `User creation failed. Please try again later. Email: ${emailError}, Market: ${marketError}, Org: ${orgError}`
      );
=======
                ...
                <div className="mb-3">
                  ...
                  {error && error.includes("Email") && (
                    <p className="text-danger">
                      {error.split("Email: ")[1].split(", Market:")[0]}
                    </p>
                  )}
                </div>
...
<<<<<<< HEAD
                <div className="mb-3">
                  ...
                  {error && error.includes("Market") && (
                    <p className="text-danger">
                      {error.split("Market: ")[1].split(", Org:")[0]}
                    </p>
                  )}
                </div>
                ...
                <div className="mb-3">
                  ...
                  {error && error.includes("Org") && (
                    <p className="text-danger">{error.split("Org: ")[1]}</p>
                  )}
                </div>
